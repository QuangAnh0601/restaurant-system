...
class CashierController extends Controller
{
    ...
    public function getTables(){
        ...
        foreach($tables as $table){
            ...
            <img src="'.url('/images/table.png').'" class="img-fluid"/>
            <br>';
        ...
        $html .= '<div class="table-responsive-md" style="overflow-y:scroll;
            ...
            $html.='</tbody></table></div>';
                ...
                if($showBtnPayment){
                    ...
                    btn-lock btn-payment" data-toggle="modal"
                     data-target="#exampleModal" >Payment</button>';
                }else{
                    $html .= '<button data-id="'.$sale_id.'" class="btn btn-warning 
                    btn-lock btn-confirm-order">Confirm Order</button>';
                }
    ...
    public function deleteSaleDetail(Request $request){
        ...
        $sale->save();
        //check if there any saledetail hanving the sale id
    ...
    public function savePayment(Request $request){
        ...
        //update sale infomation in the sale tables by using sale model
